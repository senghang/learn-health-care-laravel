...
class VitalsStep extends AbstractWorkflowStep
{
    ...
    public function id(): string       { return 'vitals'; }
    public function labelKm(): string  { return 'សញ្ញាជំងឺ'; }
    public function labelEn(): string  { return 'Vital Signs'; }
    public function icon(): string     { return '❤️'; }
    public function color(): string    { return '#e74c3c'; }
    public function description(): string { return 'T° HR BP SpO₂ Glucose'; }
