    ...
    <div class="pagetitle">
      <div class="row">
        ...
        <div class="col-md-9">
            ...
            <a href="{{ url('panel/setting/village/add') }}" class="btn btn-primary mb-3 ml-3 float-right"><i class="bi bi-plus"></i>Add</a>
          ...
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title">Import Village</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
              </div>
              <form action="{{ route('village.import') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-3">
                        <h5 class="card-title">Village List</h5>
                    </div>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                        ...
                        <a href="{{ url('panel/setting/village/edit/' . $value->id) }}" class="btn btn-sm btn-primary"><i class="bi bi-pencil"></i></a>
