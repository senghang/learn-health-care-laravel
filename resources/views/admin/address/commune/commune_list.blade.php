    ...
    <div class="pagetitle">
      <div class="row">
        ...
        <div class="col-md-9">
            ...
            <a href="{{ url('backend/commune/add') }}" class="btn btn-primary mb-3 ml-3 float-right"><i class="bi bi-plus"></i>Add</a>
          ...
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title">Import Commune</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
              </div>
              <form action="{{ route('commune.import') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-3">
                        <h5 class="card-title">Communes List</h5>
                    </div>
                    <div class="col-md-9 mt-3">
                      <form method="GET" action="{{ route('commune.list') }}">
                               ...
                               {{-- Search field --}}
                                  ...
                                  <div class="col-md-6">
                                    <select name="per_page" id="per_page" class="form-select w-auto me-2" onchange="this.form.submit()">
                                        @foreach([25, 50, 100, 'all'] as $option)
              ...
              <table class="display table table-striped">
                <thead>
                  <tr>
                    ...
                    @if(!empty($PermissionEdit) || !empty($PermissionDelete) || Auth::user()->is_admin)
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                        ...
                        <a href="{{ url('panel/setting/province/edit/' . $value->id) }}" class="btn btn-sm btn-primary"><i class="bi bi-pencil"></i></a>
