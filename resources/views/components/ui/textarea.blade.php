{{--
    <x-ui.textarea name="diagnosis" label="Diagnosis" km="រោគវិនិច្ឆ័យ" :rows="4" required />
    <x-ui.textarea name="notes" label="Notes" placeholder="Enter clinical notes…" />

    Props: same as x-ui.input (minus type/prefix/suffix)
...
$base = 'w-full text-sm rounded-lg border px-4 py-2.5 bg-white transition-colors duration-150 focus:outline-none focus:ring-2 focus:ring-offset-0 resize-y';
$normal  = 'border-[#e2e8f0] text-[#374151] placeholder-[#94a3b8] focus:border-[#4154f1] focus:ring-[#4154f1]/20';
