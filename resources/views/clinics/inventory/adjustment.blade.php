...
<x-page-header title="កែតម្រូវស្តុក" subtitle="Physical Count Adjustment"
    :breadcrumbs="[['label'=>'ដើម','url'=>route('dashboard')],['label'=>'Inventory','url'=>route('inventory.products')],['label'=>'Adjustment']]">
...
<div class="col-12 col-lg-4">
  <div class="card-emr" style="position:sticky;top:76px">
    <div class="card-hd" style="background:#eef0fd">
      <div class="card-hd-title">
        <i class="bi bi-sliders" style="color:#4154f1"></i>
        Physical Count
      </div>
    </div>
    <div class="card-bd">
