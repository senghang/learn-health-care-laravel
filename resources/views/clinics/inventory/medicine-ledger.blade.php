...
<x-page-header
    :title="$medicine->name"
    subtitle="Stock Ledger / ប្រវត្តិស្តុក"
    :breadcrumbs="[
    ...
    <a href="{{ route('inventory.product.edit', $medicine->id) }}" class="btn btn-outline-primary btn-sm">
        <i class="bi bi-pencil"></i> Edit Product
    </a>
    <a href="{{ route('inventory.stock-in') }}?medicine={{ $medicine->id }}" class="btn btn-success btn-sm">
...
<div class="col-12 col-lg-3">
    <div class="card-emr mb-3" style="position:sticky;top:76px">
        <div class="card-hd" style="background:#f6f9ff">
            <div class="card-hd-title"><i class="bi bi-capsule-pill" style="color:#4154f1"></i> Product Info</div>
        </div>
        <div class="card-bd">
            @php
