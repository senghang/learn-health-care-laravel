...
<x-page-header
    title="ការបង់ប្រាក់ / Payments"
    subtitle="Billing — Payment Ledger"
    :breadcrumbs="[
...
<div class="card-emr">
    <div class="card-hd">
        <div class="card-hd-title"><i class="bi bi-cash-stack" style="color:#4154f1"></i> Payment Records</div>
            ...
            <table class="tbl">
                ...
                <tr onclick="location.href='{{ route('payments.show', $pay->code) }}'" style="cursor:pointer">
                    ...
                    <td onclick="event.stopPropagation()">
                        <a href="{{ route('payments.show', $pay->code) }}"
