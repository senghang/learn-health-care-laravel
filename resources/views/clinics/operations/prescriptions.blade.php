            ...
            <div class="row g-2 align-items-end">
                <div class="col-12 col-sm-5">
                    <input type="text" name="search" class="form-control"
                           placeholder="{{ __('app.search') }}… ({{ __('app.patient') }}, code)"
                ...
                <div class="col-auto d-flex gap-2">
                    ...
                    <a href="{{ route('prescriptions.index') }}" class="btn btn-outline-secondary"><i class="bi bi-x-circle"></i></a>
                    @endif
                </div>
            </div>
        </form>
        ...
        <div class="table-responsive">
            <table class="tbl">
                ...
                <tr>
                    ...
                    <td>
                        @if($rx->patient)
                        <a href="{{ route('patients.show', $rx->patient->code) }}" style="font-weight:600;color:#012970;font-size:13px;text-decoration:none">
                    ...
                    <td>
                        @if($rx->visit_code)
                        <a href="{{ url('/workflow/'.$rx->visit_code) }}" style="font-size:11px;color:#4154f1">
                            {{ $rx->visit_code }}
                        </a>
                    ...
                    <td>
                        <div style="display:flex;gap:4px">
                            <a href="{{ route('prescriptions.show', $rx->code) }}" class="btn btn-sm btn-outline-primary">
                                <i class="bi bi-eye-fill"></i>
                            </a>
                            <a href="{{ route('print.prescription', $rx->code) }}" class="btn btn-sm btn-outline-secondary" target="_blank">
                ...
                @empty
                <tr><td colspan="7" style="text-align:center;padding:40px;color:#bbb">
